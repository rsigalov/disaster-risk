...
(   select
        ...
        o.best_offer, o.best_bid, (o.best_offer + o.best_bid)/2 as price,
        s.under_price as spot, o.volume, o.open_interest
    ...
    select
       o.secid, o.date, o.exdate, o.cp_flag, o.strike_price, o.impl_volatility,
       o.best_offer, o.best_bid, (o.best_offer + o.best_bid)/2 as mid_price,
